                ...
                <div class="panel-body">
                    <div class="col-sm-12 col-md-12">
                        <div class="thumbnail">
                            ...
                            <img src="{{URL::to('img/')}}/{{Auth::user()->pic}}" width="200px" height="120px" class="img-circle" src=""/>
                            <div class="caption">

                                <p align="center">{{$data->city}} - {{$data->country}}</p>
                                <p align="center">  
                                    <a href="{{URL::to('ChangePhoto')}}"  class="btn btn-primary" role="button">Change Profile Picture</a>
                                </p>
                            </div>
                        </div>
                    </div>
